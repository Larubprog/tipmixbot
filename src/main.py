...
def cleanup_data_directory():
    ...
    data_dir = "data"
    essential_files = ["detected_mixes.json", "games_with_odds.json", "player_stats_output.json", "tippmixpro_upcoming_games.json"]  # Add any essential files that should not be deleted
